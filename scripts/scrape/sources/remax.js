...
// was giving a false PT signal that let at least one real English heading
// (ending in "..., São João Baptista, Entroncamento") slip through
// uncut. Only the lowercase verb form is counted, via a separate check.
const PT_MARKERS =
